...
namespace N1c0\LessonBundle\Command;
...
class InstallAcesCommand extends ContainerAwareCommand
{
    ...
    {
        $this
            ->setName('n1c0:lesson:installAces')
...
If you have been using LessonBundle previously without Acl and are just enabling it, you
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $lessonAcl = $this->getContainer()->get('n1c0_lesson.acl.lesson');
