...
/**
 * Storage agnostic element lesson object
 */
abstract class Lesson implements LessonInterface
{
    /**
     * Id, a unique string that binds the elements together in a lesson (tree).
    ...
    /**
     * The previous state of the lesson.
     *
     * @var integer
     */
    ...
    /**
     * @return array with the names of the lesson authors
     */
    ...
    /**
     * @return array with the name of the lesson author
     */
