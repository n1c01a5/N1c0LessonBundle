...
abstract class ConclusionManager implements ConclusionManagerInterface
{
     ...
     * @throws InvalidConclusionException when the conclusion does not have a lesson.
     */
    public function saveConclusion(ConclusionInterface $conclusion)
    {
        if (null === $conclusion->getLesson()) {
            throw new InvalidConclusionException('The conclusion must have a lesson');
        }
