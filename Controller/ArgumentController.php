...
use N1c0\LessonBundle\Form\ArgumentType;
...
class ArgumentController extends FOSRestController
{
     ...
     *   output = "N1c0\LessonBundle\Entity\Argument",
     *   statusCodes = {
     *     200 = "Returned when successful",
     *     404 = "Returned when the argument or the lesson is not found"
     *   }
     * )
     *
     *
     ...
     * 
     * @Annotations\View(
     *  template = "N1c0LessonBundle:Argument:editArgument.html.twig",
     *  templateVar = "form"
     * )
     *
     * @param int     $id                   the lesson id
    ...
    /**
     * Creates a new Argument for the Lesson from the submitted data.
     *
     * @ApiDoc(
     *   resource = true,
     *   description = "Creates a new argument for the lesson from the submitted data.",
     *   input = "N1c0\LessonBundle\Form\ArgumentType",
     *   statusCodes = {
     *     200 = "Returned when successful",
     ...
     *
     * @Annotations\View(
     *  template = "N1c0LessonBundle:Argument:newArgument.html.twig",
    ...
    /**
     * Update existing argument for a lesson from the submitted data or create a new argument at a specific location.
     *
     * @ApiDoc(
     *   resource = true,
     *   input = "N1c0\DemoBundle\Form\ArgumentType",
     ...
     *
     * @Annotations\View(
     *  template = "N1c0LessonBundle:Argument:editLessonArgument.html.twig",
     *  templateVar = "form"
     * )
     *
     * @param Request $request         the request object
    ...
    {
        if (!($argument = $this->container->get('n1c0_lesson.manager.argument')->findArgumentById($id))) {
    ...
    /**
     * Get download for the argument of the lesson.
     *
     * @ApiDoc(
     *   resource = true,
    ...
    public function getArgumentConvertAction($id, $partId, $argumentId, $format)
    {
        ...
        $argumentConvert = $this->container->get('n1c0_lesson.argument.download')->getConvert($argumentId, $format);
