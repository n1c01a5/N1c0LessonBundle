...
class LogIntroductionController extends FOSRestController
{
     ...
     *
     * @Annotations\View(
     *  template = "N1c0LessonBundle:Introduction:getLogs.html.twig",
     *  templateVar="logs"   
     * )
     *
    ...
    public function getLogsAction($id, $introductionId)
    {
        ...
        if ($introduction = 
            $this->container->get('n1c0_lesson.manager.introduction')->findIntroductionById($introductionId)) {
            $entity = $em->find('Bundle\LessonBundle\Entity\Introduction', $introduction->getId());
        } else {
